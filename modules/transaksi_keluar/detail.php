<?php
// modules/transaksi_keluar/detail.php - Detail Transaksi Barang Keluar
$pageTitle = 'Detail Transaksi Barang Keluar';
...
// Fetch Header
$stmt = $pdo->prepare("SELECT * FROM transaksi_keluar WHERE no_transaksi = ?");
$stmt->execute([$no]);
$header = $stmt->fetch();
...
// Fetch Items
$stmtItems = $pdo->prepare("SELECT tkd.*, b.nama_barang, b.satuan, k.nama_kategori 
                            FROM transaksi_keluar_detail tkd 
                            JOIN barang b ON tkd.kode_barang = b.kode_barang 
                            JOIN kategori k ON b.kategori_id = k.id 
                            WHERE tkd.no_transaksi = ? 
                            ORDER BY tkd.id ASC");
        ...
        <div class="card card-table border-0 shadow-sm">
            <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="m-0 fw-bold"><i class="bi bi-file-text me-2 text-danger"></i>Detail Transaksi Barang Keluar</h5>
                </div>
            ...
            <div class="card-body p-4">
                <div class="row mb-4 p-3 bg-light rounded border">
                    <div class="col-md-4">
                        ...
                        <span class="fw-bold font-monospace fs-5 text-danger"><?= htmlspecialchars($header['no_transaksi']); ?></span>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <span class="text-muted fs-7 d-block">Tujuan / Penerima:</span>
                        <span class="fw-semibold text-slate-800"><?= htmlspecialchars($header['tujuan']); ?></span>
                    </div>
                </div>

                <h6 class="fw-bold mb-3"><i class="bi bi-box-seam me-2"></i>Daftar Barang Keluar</h6>
                    ...
                    <table class="table table-bordered align-middle">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center" style="width: 130px;">Jumlah Keluar</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center fw-bold text-danger">-<?= $d['jumlah']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                        <tfoot>
                            <tr class="table-light fw-bold">
                                <td colspan="5" class="text-end">Total Barang Keluar:</td>
                                <td class="text-center text-danger fs-6">-<?= $totalQty; ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
